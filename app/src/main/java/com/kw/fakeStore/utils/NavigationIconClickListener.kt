...
class NavigationIconClickListener @JvmOverloads internal constructor(
    private val context: Context, private val toolbar: Toolbar,
    private val sheet: View, private val interpolator: Interpolator? = null,
    ...
    override fun onClick(view: View) {
        ...
        val translateY = height - context.resources.getDimensionPixelSize(R.dimen.main_page_reveal_height)
